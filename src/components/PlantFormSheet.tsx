...
export const PlantFormSheet: React.FC<Props> = ({
  ...
  return (
    <BottomSheet
      ...
      footer={footer}
    >
      <form onSubmit={handleSubmit} className="p-5 sm:p-6 space-y-5 break-keep min-w-0 w-full max-w-full overflow-x-hidden">
        ...
        <div className="min-w-0">
          ...
          {showPresetPicker && (
            <div className="mt-3 p-3 bg-gray-50 rounded-xl border border-gray-200 min-w-0">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 min-w-0">
          <div className="min-w-0">
            ...
            <input
              ...
              className="w-full min-w-0 px-3.5 py-2.5 rounded-xl border border-gray-200 text-sm bg-white"
            />
          </div>

          {/* Species with Auto-complete Presets */}
          <div className="relative min-w-0" ref={autocompleteRef}>
            <label className="block text-xs font-semibold text-gray-700 mb-1.5 whitespace-nowrap">
              식물 품종
            </label>
            <div className="relative min-w-0">
              <input
                ...
                className="w-full min-w-0 pl-3.5 pr-8 py-2.5 rounded-xl border border-gray-200 text-sm bg-white"
              />
        ...
        {(() => {
          ...
          return (
            <div className="bg-water-bg p-4 rounded-2xl border border-sky-100/90 space-y-2.5 min-w-0">
              ...
              <div className="py-1">
                <input
                  ...
                  className="plant-slider cursor-pointer min-w-0"
                />
              </div>
          ...
          <div className="min-w-0">
            ...
            <div className="relative min-w-0">
              <select
                ...
                className="w-full min-w-0 appearance-none pl-3.5 pr-9 py-2.5 rounded-xl border border-gray-200 text-sm bg-white cursor-pointer"
              >
